...
$get_admin = "SELECT * from admins where status='admin' or status='lecturer'";
...
<td>
<a class="btn btn-warning" href="index.php?user_profile=<?php echo $admin_id; ?>">
<i class="fa fa-pencil" ></i> Edit
</a>
</td>
<td>
<a class="btn btn-danger" href="index.php?user_delete=<?php echo $admin_id; ?>" onclick="return confirm('Are You Sure To Delete?')">
